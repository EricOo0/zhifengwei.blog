...
原因：这个网站是被墙的，需要科学上网  
或者复制下方脚本到桌面上并执行，但clone 的步骤可能还是会报错，最好还是翻墙安装，或者自己先clone到国内repo里吧
```
#!/bin/sh
#
...
2.4、 cd fonts && ./install.sh 安装字体  
2.5、按cmd+‘，’；选择profile text的font栏选择带powerline的字体，color里可以选择喜欢的主题  
至此，终端已经有点样子了。
步骤参考：https://zhuanlan.zhihu.com/p/361282459